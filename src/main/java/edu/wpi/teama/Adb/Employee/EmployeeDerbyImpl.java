...
public class EmployeeDerbyImpl implements  EmployeeDAO{
    ...
    public static Employee getEmployee(String ID){
        try{
            ...
            Employee emp = new Employee(employeeID, employeeType, firstName, lastName,
                    email, phoneNum, address, startDate);
    ...
    public static void enterEmployee(String employeeID, String employeeType, String firstName,
        ...
        try{
            ...
            String str = String.format("INSERT INTO Employee(employeeID, employeeType, firstName, " +
