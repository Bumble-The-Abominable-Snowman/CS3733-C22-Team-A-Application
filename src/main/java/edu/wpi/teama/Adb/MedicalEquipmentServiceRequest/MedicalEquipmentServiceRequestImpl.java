...
public class MedicalEquipmentServiceRequestImpl implements MedicalEquipmentServiceRequestDAO{
    ...
    public static MedicalEquipmentServiceRequest getMedicalEquipmentServiceRequest(String ID){
        try{
            ...
            String str = String.format("SELECT * FROM MedicalEquipmentServiceRequest WHERE equipmentID = '%s'",ID);
            ...
            MedicalEquipmentServiceRequest mesr = new MedicalEquipmentServiceRequest(
                    ...
                    requestTime, requestStatus, equipmentID, requestType);
    ...
    public static void updateMedicalEquipmentServiceRequest(String ID, String field, String change){
        try{
            ...
            String str =
                    String.format(
                            "UPDATE MedicalEquipmentServiceRequest SET " + field + " = %s WHERE requestID = '%s'", change, ID);
            update.execute(str);
        } catch(SQLException e){
    ...
    public static void enterMedicalEquipmentServiceRequest(String requestID, String startLocation,
        ...
        try{
            ...
            String str = String.format("INSERT INTO MedicalEquipmentServiceRequest(requestID, startLocation, endLocation, " +
                    "employeeRequested, employeeAssigned, requestTime, requestStatus, equipmentID, requestType) " +
            " VALUES('%s', '%s', '%s', '%s', '%s', '%s', '%1$TD %1$TT', '%s', '%s', '%s');",
                    requestID, startLocation, endLocation, employeeRequested, employeeAssigned, requestTime, requestStatus,
    ...
    public static void deleteMedicalEquipment(String ID){
        try{
            ...
            String str = String.format("DELETE FROM MedicalEquipmentServiceRequest WHERE requestID = '%s'", ID);
            delete.execute(str);
        ...
        try {
            ...
            while (rset.next()) {
                ...
                MedicalEquipmentServiceRequest mesr =
                        new MedicalEquipmentServiceRequest(requestID, startLocation, endLocation, employeeRequested, employeeAssigned,
                                requestTime, requestStatus, equipmentID, requestType);
                reqList.add(mesr);
            }
        } catch (SQLException e) {
