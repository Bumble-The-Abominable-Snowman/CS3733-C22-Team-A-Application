...
public class MedicalEquipmentImpl implements MedicalEquipmentDAO{
    ...
    public MedicalEquipment getMedicalEquipment(String ID){
        try{
            ...
            MedicalEquipment me = new MedicalEquipment(equipmentID, equipmentType,
                    isClean, currentLocation, isAvailable);
    ...
    public List<MedicalEquipment> getMedicalEquipmentList() {
        ...
        try {
            ...
            while (rset.next()) {
                ...
                MedicalEquipment e = new MedicalEquipment(equipmentID, equipmentType, isClean, currentLocation, isAvailable);
                equipList.add(e);
            }
        } catch (SQLException e) {
            System.out.println("Failed");
