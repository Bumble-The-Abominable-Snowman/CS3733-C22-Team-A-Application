...
public class SelectionManager {
  ...
  public SelectionManager(
      ...
      VBox inputVBox,
      JFXTextArea nodeIDText,
      JFXTextArea xPosText,
      JFXTextArea yPosText,
      JFXTextArea floorText,
      JFXTextArea buildingText,
      JFXTextArea typeText,
      JFXTextArea longnameText,
      JFXTextArea shortnameText) {
