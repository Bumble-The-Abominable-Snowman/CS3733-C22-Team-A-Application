...
public class ServiceRequestDerbyImpl implements ServiceRequestDAO {
  ...
  @Override
  public SR getRequest(String ID) throws SQLException {
  ...
  @Override
  public void updateServiceRequest(SR sr) throws SQLException {
    Connection connection =
        DriverManager.getConnection(
            String.format("jdbc:derby:%s;user=Admin;password=admin", Adb.pathToDBA));
    Statement get = connection.createStatement();
  ...
  @Override
  public List<SR> getServiceRequestList() throws SQLException, IllegalAccessException {
    Connection connection =
        DriverManager.getConnection(
            String.format("jdbc:derby:%s;user=Admin;password=admin", Adb.pathToDBA));
